...
export default function Footer() {
  return (
    <footer className="mt-[5rem] md:flex flex-col items-center justify-center  bg-[#1e2121] px-4 py-6 hidden">
      <div className="mx-auto mb-6 md:flex-col xl:flex xl:flex-row w-full max-w-[75rem] justify-between gap-x-15">
        <div className="md:w-full xl:w-[50%]">
          <div
          ...
          <div>
            ...
            <div className="flex lg:w-[50%] w-[60%] xl:w-[65%] justify-between">
        ...
        <div className="flex md:w-full md:mt-10 xl:w-[40%] justify-between">
